...
Un «&#xA0;taux d'apprentissage" (*learning rate*) est utilisé pour déterminer dans quelle mesure un modèle doit être mis à jour sur la base de la perte calculée. Il s'agit d'une autre variable importante qui peut être manipulée au cours du processus de formation. Dans la [Partie 2 de cette leçon](/fr/lessons/computer-vision-deep-learning-pt1), nous verrons une façon potentielle d'essayer d'identifier un taux d'apprentissage approprié pour votre modèle.
